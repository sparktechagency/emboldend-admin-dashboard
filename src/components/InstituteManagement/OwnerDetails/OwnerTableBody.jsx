  ...
  return (
    <>
      ...
      <div className="grid items-center grid-cols-10 gap-2 px-2 my-3 text-sm bg-gray-100 rounded-lg whitespace-nowrap">
        ...
        <div className="flex items-center justify-center py-3  ">{item.instituteName.split(' ').slice(0, 2).join(' ')}</div>
            ...
            >
              ...
              <div className="p-4 rounded-lg border-primary mt-3 border">
                ...
                <div className="space-y-5">
                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Name:</span> {item.instituteName || "Brookwood Baptist Health"}
                    </p>
                  </div>

                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Phone Number:</span> {item.phoneNumber || "+12345657962"}
                    </p>
                  </div>

                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Email:</span> {item.email || "example@gmail.com"}
                    </p>
                  </div>

                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Institute Type:</span> {item.type || "Medical"}
                    </p>
                  </div>

                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Address:</span> {item.address || "500 N. Eastern Blvd. Montgomery, AL 36117."}
                    </p>
                  </div>

                  <div>
                    <p className="text-md">
                      <span className="font-semibold">Website Link:</span> {item.website || "WWW.example website. com"}
                    </p>
                  </div>
                </div>
              </div>
